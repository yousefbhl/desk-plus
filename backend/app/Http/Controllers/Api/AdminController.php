...
{
    // GET /api/admin/stats
    // Main CEO dashboard — total users, revenue, best seller, monthly chart
    ...
    public function exportReport(Request $request)
    {
        ...
        return response($csv, 200, [
            ...
            'Content-Disposition' => "attachment; filename=\"deskplus-{$type}-report.csv\"",
        ]);
    }

    // GET /api/admin/reviews  — pending reviews moderation
